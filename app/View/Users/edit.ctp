...
<?php echo $this->Form->create('User'); ?>
    <fieldset>
        ...
        echo $this->Form->input('username', array( 'readonly' => 'readonly', 'label' => 'Username cannot be changed!'));
        ...
        echo $this->Form->submit('Edit User', array('class' => 'button tiny radius',  'title' => 'Click here to add the user') ); 
?>
    </fieldset>
