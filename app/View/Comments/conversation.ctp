<div class="row alert-box info radius" style="padding-left: 1.5rem!important">
    <div class="row" >
        ...
        <div class="small-10 columns">
            <ul class="side-nav">
                <li>Site Name: <?php echo $sites['Site']['site_name']?></li>
                <li>講師数: <?php echo $sites['Site']['no_teachers']; ?></li>
                <li>入会金: <?php echo $sites['Site']['admission_fee']; ?></li>
                <li>値段:</li>
                <li>Ratings: </li>
        ...
        <div class="row">
            ...
            <div class="row collapse" style="margin-top: 10px; margin-bottom: 10px;">
                <div class="small-10 columns">
                    ...
                    <?php echo $this->Form->input(_('site_id'), array('type' => 'hidden', 'value' => $sites['Site']['id']));?>
