...
<?php echo $this->Form->create('Instructor', array('enctype'=>'multipart/form-data')); ?>
	...
	<?php
		...
		echo $this->Form->input('gender', array('label' => '性別 Gender',  'type'=>'select',
                        'options'=> $gender));
		echo $this->Form->input('birth', array('label' => '生年月日', 'id' => 'datepicker', 'name' => 'data[Instructor][birthdate]', 'class' => 'readonly', 'default' => $birthdate));
		echo $this->Form->input('age', array('label' => '年齢', 'id' => 'age', 'class' => 'readonly', 'default' => $age));
