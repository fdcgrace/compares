...
<?php echo $this->Form->create('Instructor'); ?>
	...
	<?php
		...
		echo $this->Form->input('birth', array('label' => '生年月日 Date of Birth', 'id' => 'datepicker', 'name' => 'data[Instructor][birthdate]', 'default' => $get_birthdate, 'class' => 'readonly'));
		echo $this->Form->input('age', array('label' => '年齢 Age', 'id' => 'age', 'class' => 'readonly'));
